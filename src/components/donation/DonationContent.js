            ...
            <div className="row">
                ...
                <div className="causes-one__single">
                  ...
                  <div className="causes-one__content-box">
                    ...
                    <div className="causes-one__content">
                      <h3 className="causes-one__title">
                        <Link to={process.env.PUBLIC_URL + `/donation-details`}>
                          Raise Hand To The Change Children Education.
                        </Link>
                      </h3>
                      <div className="causes-one__progress">
                        <div className="bar">
              ...
              >
                ...
                <div className="causes-one__single">
                  <div className="causes-one__img">
                    <img
                      src={publicUrl + "assets/images/resources/causes-1-4.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="causes-one__content-box">
              ...
              >
                ...
                <div className="causes-one__single">
                  <div className="causes-one__img">
                    <img
                      src={publicUrl + "assets/images/resources/causes-1-5.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="causes-one__content-box">
                    ...
                    <div className="causes-one__content">
                      <h3 className="causes-one__title">
                        <Link to={process.env.PUBLIC_URL + `/donation-details`}>
                          Provide Healthy Food for African Change People.
                        </Link>
                      </h3>
                      <div className="causes-one__progress">
                        <div className="bar">
              ...
              >
                ...
                <div className="causes-one__single">
                  <div className="causes-one__img">
                    <img
                      src={publicUrl + "assets/images/resources/causes-1-6.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="causes-one__content-box">
