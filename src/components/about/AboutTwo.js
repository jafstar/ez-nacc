    ...
    return (
      <>
        <section className="about-two">
          <div className="about-two-shape-1 float-bob-x">
            <img
              src={publicUrl + "assets/images/shapes/about-two-shape-1.png"}
              alt=""
            />
          </div>
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" +
                        publicUrl +
                        "assets/images/backgrounds/about-two-bg.jpg)",
                    }}
                  ></div>
                  <div
                  ...
                  >
                    <div className="about-two__img">
                      <img
                        src={
                          publicUrl +
                          "assets/images/resources/about-two-img-1.jpg"
                        }
                        alt=""
                      />
                    </div>
                    <div
                      className="about-two__small-img wow zoomIn animated animated"
                    ...
                    >
                      <img
                        src={
                          publicUrl +
                          "assets/images/resources/about-two-small-img.jpg"
                        }
                        alt=""
                      />
                    </div>
                ...
                <div className="about-two__right">
                  <div className="section-title text-left">
                    ...
                    <h2 className="section-title__title">
                      The Community To Give as Children Change.
                    </h2>
                  </div>
