            ...
            <div className="row">
              ...
              >
                ...
                <div className="project-one__single">
                  <div className="project-one__img">
                    <img
                      src={publicUrl + "assets/images/project/project-1-1.jpg"}
                      alt=""
                    />
              ...
              >
                ...
                <div className="project-one__single">
                  <div className="project-one__img">
                    <img
                      src={publicUrl + "assets/images/project/project-1-2.jpg"}
                      alt=""
                    />
                    <div className="project-one__content">
                      <p className="project-one__sub-title">
                ...
                <div className="project-one__single">
                  <div className="project-one__img">
                    <img
                      src={publicUrl + "assets/images/project/project-1-3.jpg"}
                      alt=""
                    />
                    <div className="project-one__content">
                      <p className="project-one__sub-title">
              ...
              >
                ...
                <div className="project-one__single">
                  <div className="project-one__img">
                    <img
                      src={publicUrl + "assets/images/project/project-1-4.jpg"}
                      alt=""
                    />
                    <div className="project-one__content">
                      <p className="project-one__sub-title">
                ...
                <div className="project-one__single">
                  <div className="project-one__img">
                    <img
                      src={publicUrl + "assets/images/project/project-1-5.jpg"}
                      alt=""
                    />
                    <div className="project-one__content">
                      <p className="project-one__sub-title">
