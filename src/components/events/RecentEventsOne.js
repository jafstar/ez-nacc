                ...
                <div className="recent-event__single">
                  <div className="recent-event__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/recent-event-1-1.jpg"
                      }
                      alt=""
                    />
                  ...
                  <div className="recent-event__content">
                    ...
                    <p className="recent-event__text">
                      To make sure education of change While atever motivates
                      you to you no idea of where to.
                    </p>
                  </div>
                </div>
                {/* Recent Event Single */}
                <div className="recent-event__single">
                  <div className="recent-event__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/recent-event-1-2.jpg"
                      }
                      alt=""
                    />
                    <div className="recent-event__btn-box">
                ...
                <div className="recent-event__single">
                  <div className="recent-event__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/recent-event-1-3.jpg"
                      }
                      alt=""
                    />
                    <div className="recent-event__btn-box">
                ...
                <div className="recent-event__single">
                  <div className="recent-event__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/recent-event-1-4.jpg"
                      }
                      alt=""
                    />
                    <div className="recent-event__btn-box">
                ...
                <div className="recent-event__single">
                  <div className="recent-event__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/recent-event-1-5.jpg"
                      }
                      alt=""
                    />
                    <div className="recent-event__btn-box">
                ...
                <div className="recent-event__single">
                  <div className="recent-event__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/recent-event-1-6.jpg"
                      }
                      alt=""
                    />
                    <div className="recent-event__btn-box">
