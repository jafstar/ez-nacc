              ...
              <SwiperSlide className="swiper-slide">
                ...
                <div className="main-slider-two__map">
                  <img
                    src={
                      publicUrl +
                      "assets/images/shapes/main-slider-two-map-1.png"
                    }
                    alt=""
                  />
                </div>
                  ...
                  <div className="row">
                    <div className="col-xl-6 col-lg-7">
                      <div className="main-slider__content">
                        <h2>
                          Building <span>Healthy</span> &amp; <br /> Resilient
                          Communities
                        </h2>
                        <p>
                          There are many variations of passages of Lorem Ipsum
                          Fasts by injected humour, or randomised words which...{" "}
                        </p>
                        <Link
              ...
              <SwiperSlide className="swiper-slide">
                ...
                <div className="main-slider-two__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/resources/main-slider-img-2.jpg"
                    }
                    alt=""
                  />
                </div>
                <div className="container">
                  <div className="row">
                    <div className="col-xl-6 col-lg-7">
                      <div className="main-slider__content">
                        <h2>
                          Give the <span>Change</span> Help for Families.
                        </h2>
                        <p>
                          There are many variations of passages of Lorem Ipsum
                          Fasts by injected humour, or randomised words which...{" "}
              ...
              <SwiperSlide className="swiper-slide">
                ...
                <div className="main-slider-two__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/resources/main-slider-img-3.jpg"
                    }
                    alt=""
                  />
                </div>
