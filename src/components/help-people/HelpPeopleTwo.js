    ...
    return (
      <>
        <section className="help-one">
          <div
            className="help-one-bg jarallax"
            data-jarallax
            data-speed="0.2"
            ...
            style={{
              backgroundImage:
                "url(" +
                publicUrl +
                "assets/images/backgrounds/help-one-bg.jpg)",
            }}
          ></div>
                ...
                <div className="help-one__content-box">
                  <div className="help-one__single">
                    ...
                    <div className="help-one__content">
                      ...
                      <p>
                        To make sure education of change children While atever
                        motivates you to host,your participation has the.
                      </p>
                    </div>
                  </div>
                  <div className="help-one__single">
