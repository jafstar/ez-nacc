              ...
              >
                ...
                <div className="feature-two__single">
                  <div className="feature-two__img">
                    <img
                      src={
                        publicUrl + "assets/images/resources/feature-2-1.jpg"
                      }
                      alt=""
                    />
                  </div>
                    ...
                    <div className="feature-two__top">
                      ...
                      <h3 className="feature-two__title">
                        <Link to={process.env.PUBLIC_URL + `/about`}>
                          Implest and Quickest
                        </Link>
                      </h3>
                    </div>
                    <p className="feature-two__text">
                      While building out a new website you literally no idea of
                      where to start.
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <div className="feature-two__single">
                  <div className="feature-two__img">
                    <img
                      src={
                        publicUrl + "assets/images/resources/feature-2-2.jpg"
                      }
                      alt=""
                    />
                  </div>
              ...
              >
                ...
                <div className="feature-two__single">
                  <div className="feature-two__img">
                    <img
                      src={
                        publicUrl + "assets/images/resources/feature-2-3.jpg"
                      }
                      alt=""
                    />
                  </div>
