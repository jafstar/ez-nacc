      ...
      $(".up-comming-event-two .tabs-button-box .tab-btn-item").on(
        ...
        function (e) {
          ...
          if ($(target).hasClass("actve-tab")) {
            ...
            $(
              ".up-comming-event-two .tabs-button-box .tab-btn-item"
                      ...
                      <div className="up-comming-event-two__bottom">
                        <div className="up-comming-event-two__single">
                          <div className="up-comming-event-two__location-box">
                            <h5 className="up-comming-event-two__location-title">
                ...
                <div className="up-comming-event-two__right">
                  <div className="up-comming-event-two__img">
                    <img
                      src={
                        publicUrl +
                        "assets/images/resources/up-comming-event-two-img.jpg"
                      }
                      alt=""
                    />
                  </div>
