...
const EZHero = ({ content }) => {
  ...
  const colorBodyBG = content.color_bodyBG ? `${content.color_bodyBG}` : "transparent";
  ...
  return (
    ...
    >
      <div>
        ...
        <p
          style={{ color: colorBody, backgroundColor: hexToRgba(colorBodyBG.replace("#",""), '0.5'), padding: "20px", borderRadius: "10px" }}
