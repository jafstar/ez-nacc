            ...
            <div className="row">
                ...
                <div className="team-one__single">
                  ...
                  <div className="team-one__content">
                    <h4 className="team-one__name">
                      <Link
                        href={
                          process.env.NEXT_PUBLIC_PUBLIC_URL + `/team-details`
                        }
                      >
                        Kavin Martin
                      </Link>
              ...
              >
                ...
                <div className="team-one__single">
                  <div className="team-one__img">
                    <img
                      src={publicUrl + "assets/images/team/team-1-4.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="team-one__content">
              ...
              >
                ...
                <div className="team-one__single">
                  <div className="team-one__img">
                    <img
                      src={publicUrl + "assets/images/team/team-1-5.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="team-one__content">
              ...
              >
                ...
                <div className="team-one__single">
                  <div className="team-one__img">
                    <img
                      src={publicUrl + "assets/images/team/team-1-6.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="team-one__content">
