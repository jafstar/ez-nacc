              ...
              <div className="col-xl-8 col-lg-7">
                <div className="blog-details__left">
                  <div className="blog-details__img">
                    <img
                      src={
                        publicUrl + "assets/images/blog/blog-details-img-1.jpg"
                      }
                      alt=""
                    />
                  ...
                  <div className="blog-details__content">
                    <ul className="blog-details__meta list-unstyled">
                      <li>
                        <Link
                          href={
                            process.env.NEXT_PUBLIC_PUBLIC_URL + `/blog-details`
                          }
                        >
                    ...
                    <p className="blog-details__text-1">
                      ...
                      cupidatat none proident, sunt in culpa qui officia
                      deserunt mollit anim id est laborum. Sed ut is a
                      perspiciatis unde omnis iste natus error sit voluptatem
                      accusantium doloremque laudantium, totam rem aperiam,
                      eaque ipsa quae ab illo inventore veritatis equasi
                      architecto beatae vitae dicta sunt explicabo. Nemo enim
                      ipsam voluptatem quia voluptas sit aspernatur aut odit aut
                      fugit, sed quia consequuntur magni doloreeos qui ratione
                  ...
                  <div className="blog-details__content-two">
                    <div className="blog-details__content-two-img">
                      <img
                        src={
                          publicUrl +
                          "assets/images/blog/blog-details-img-2.jpg"
                        }
                        alt=""
                      />
                    </div>
                    <div className="blog-details__content-two-details">
                      ...
                      <ul className="list-unstyled blog-details__content-two-points">
                        ...
                        <li>
                          Beast itself doesn&apos;t signs they are so together
                          signs for the called.
                        </li>
                        <li>
                  ...
                  <div className="author-one">
                    <div className="author-one__image">
                      <img
                        src={publicUrl + "assets/images/blog/author-1-1.jpg"}
                        alt=""
                      />
                    </div>
                    <div className="author-one__content">
                      <h3>Hover Cameron</h3>
                      <p>
                        Lorem ipsum is simply free text by copytyping
                  ...
                  <div className="comment-one">
                    ...
                    <div className="comment-one__single">
                      <div className="comment-one__image">
                        <img
                          src={publicUrl + "assets/images/blog/comment-1-1.jpg"}
                          alt=""
                        />
                      </div>
                    ...
                    <div className="comment-one__single">
                      <div className="comment-one__image">
                        <img
                          src={publicUrl + "assets/images/blog/comment-1-2.jpg"}
                          alt=""
                        />
                      </div>
                      <div className="comment-one__content">
