...
const SubMenu = ({ item }) => {
  ...
  return (
    <>
      <SidebarLink
        href={process.env.NEXT_PUBLIC_PUBLIC_URL + `${item.path}`}
      ...
      {subnav &&
        item.subNav.map((data, index) => (
          <DropdownLink
            href={process.env.NEXT_PUBLIC_PUBLIC_URL + `${data.path}`}
            key={index}
          >
            {item.icon}
...
const MobileMenu = () => {
  ...
  return (
    <>
      <>
        <NavIcon href="#" style={{ justifyContent: "flex-end" }}>
            ...
            <div className="mobile-nav__content">
              ...
              <ul className="mobile-nav__contact list-unstyled">
                ...
                <li>
                  ...
                  <a href="tel:123-888-0000">123 888 0000</a>
                </li>
              </ul>
