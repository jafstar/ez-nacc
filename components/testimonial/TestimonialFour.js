              ...
              <div className="testimonial-one__single">
                <div className="testimonial-one__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/testimonial/testimonial-1-2.jpg"
                    }
                    alt=""
                  />
                  <div className="testimonial-one__quote">
              ...
              <div className="testimonial-one__single">
                <div className="testimonial-one__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/testimonial/testimonial-1-3.jpg"
                    }
                    alt=""
                  />
                  <div className="testimonial-one__quote">
              ...
              <div className="testimonial-one__single">
                <div className="testimonial-one__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/testimonial/testimonial-1-4.jpg"
                    }
                    alt=""
                  />
                  <div className="testimonial-one__quote">
              ...
              <div className="testimonial-one__single">
                <div className="testimonial-one__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/testimonial/testimonial-1-5.jpg"
                    }
                    alt=""
                  />
                  <div className="testimonial-one__quote">
              ...
              <div className="testimonial-one__single">
                <div className="testimonial-one__img">
                  <img
                    src={
                      publicUrl +
                      "assets/images/testimonial/testimonial-1-6.jpg"
                    }
                    alt=""
                  />
                  <div className="testimonial-one__quote">
