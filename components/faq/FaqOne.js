            ...
            <div className="row">
                ...
                <div className="faq-one__left">
                  <div className="section-title text-left">
                    ...
                    <h2 className="section-title__title">
                      We out The Form Prepared at <br /> Your Contact?
                    </h2>
                  </div>
                        ...
                        <div className="accrodion-content">
                          <div className="inner">
                            <p>
                              ...
                              alteration in some we form, by injected humour
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="col-xl-6 col-lg-5">
                <div className="faq-one__right">
                  <div
                    className="faq-one__img wow slideInRight"
                    data-wow-delay="100ms"
                    data-wow-duration="2500ms"
                  >
                    <img
                      src={publicUrl + "assets/images/resources/faq-1-1.png"}
                      alt=""
                    />
                  </div>
                </div>
